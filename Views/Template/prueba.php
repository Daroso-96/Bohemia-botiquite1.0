    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>/dashboard">
                ...
                <div class="sidebar-brand-text mx-3"> Admin <sup>Bohemia</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url(); ?>/clientes" data-toggle="collapse" data-target="#collapseUtilities"
